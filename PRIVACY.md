# Privacy Policy — WinTask Scheduler

**Effective date:** June 7, 2026

WinTask Scheduler ("the app") is a desktop application for Windows that creates,
...
- **App settings and preferences** — for example theme, window material, the
  ...
  created by WinTask Scheduler" filter, run-on-sign-in, and whether AI features are
...
**Disclaimer:** WinTask Scheduler is an individual personal project and proof of
