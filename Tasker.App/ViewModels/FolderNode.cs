...
public partial class FolderNode : ObservableObject
{
        ...
        IReadOnlyDictionary<string, int>? taskerCounts = null)
    {
        Name = dto.Name;
        Path = dto.Path;
        // When filtering to Windows Tasker tasks, show this folder's direct Tasker-task count
        ...
        {
            // While filtering, skip folders whose subtree has no Windows Tasker tasks.
